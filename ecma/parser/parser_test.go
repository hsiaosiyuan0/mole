...
func TestExpr(t *testing.T) {
	...
	a := ab.lhs
	AssertEqual(t, "a", a.(*Ident).Text(), "should be name a")
	AssertEqual(t, "+", ab.OpText(), "should be +")
	b := ab.rhs
	AssertEqual(t, "b", b.(*Ident).Text(), "should be name b")

	c := expr.rhs
	AssertEqual(t, "c", c.(*Ident).Text(), "should be name c")
}
...
func TestExprPcdHigherRight(t *testing.T) {
	...
	AssertEqual(t, "a", lhs.(*Ident).Text(), "should be name a")
	...
	lhs = rhs.(*BinExpr).lhs
	AssertEqual(t, N_NAME, lhs.Type(), "should be name")
	AssertEqual(t, "b", lhs.(*Ident).Text(), "should be name b")

	rhs = rhs.(*BinExpr).rhs
	AssertEqual(t, N_NAME, rhs.Type(), "should be name")
	AssertEqual(t, "c", rhs.(*Ident).Text(), "should be name c")
}
...
func TestAssign(t *testing.T) {
	...
	a := expr.lhs.(*Ident)
	AssertEqual(t, "a", a.Text(), "should be a")
...
func TestMemberExprSubscript(t *testing.T) {
	...
	AssertEqual(t, "a", ab.obj.(*Ident).Text(), "should be a")
	AssertEqual(t, "b", ab.prop.(*Ident).Text(), "should be b")
	AssertEqual(t, "c", expr.prop.(*Ident).Text(), "should be c")
}
...
func TestUnaryExpr(t *testing.T) {
	...
	AssertEqual(t, "0", v0.arg.(*NumLit).Text(), "should be 0")
}
...
func TestUpdateExpr(t *testing.T) {
	...
	expr := ast.(*Prog).stmts[0].(*ExprStmt).expr.(*BinExpr)
	ab := expr.lhs.(*BinExpr)
	AssertEqual(t, "a", ab.lhs.(*Ident).Text(), "should be a")

	u1 := ab.rhs.(*UpdateExpr)
	AssertEqual(t, "b", u1.arg.(*Ident).Text(), "should be b")
	AssertEqual(t, true, u1.prefix, "should be prefix")

	u2 := expr.rhs.(*UpdateExpr)
	AssertEqual(t, "c", u2.arg.(*Ident).Text(), "should be c")
...
func TestNewExpr(t *testing.T) {
	...
	AssertEqual(t, "a", expr.callee.(*Ident).Text(), "should be a")
}
...
func TestCallExpr(t *testing.T) {
	...
	AssertEqual(t, "a", callee.callee.(*Ident).Text(), "should be b")

	params := expr.args
	AssertEqual(t, "c", params[0].(*Ident).Text(), "should be c")
	AssertEqual(t, "a", params[2].(*Spread).arg.(*Ident).Text(), "should be b")
	AssertEqual(t, "b", params[1].(*Ident).Text(), "should be a")
}
...
func TestCallExprMem(t *testing.T) {
	...
	AssertEqual(t, "a", callee.Text(), "should be a")
	AssertEqual(t, "c", expr.prop.(*Ident).Text(), "should be c")

	params := obj.args
	AssertEqual(t, "b", params[0].(*Ident).Text(), "should be b")
}
...
func TestCallCascadeExpr(t *testing.T) {
	...
	e := expr0.prop.(*Ident)
	AssertEqual(t, "e", e.Text(), "should be e")

	// a[b][c]()
	expr2 := expr1.obj.(*CallExpr)
	d := expr1.prop.(*Ident)
	AssertEqual(t, "d", d.Text(), "should be d")

	// a[b][c]
	expr3 := expr2.callee.(*MemberExpr)
	c := expr3.prop.(*Ident)
	AssertEqual(t, "c", c.Text(), "should be c")

	// a[b]
	expr4 := expr3.obj.(*MemberExpr)
	b := expr4.prop.(*Ident)
	AssertEqual(t, "b", b.Text(), "should be b")
	AssertEqual(t, "a", expr4.obj.(*Ident).Text(), "should be a")
}
...
func TestVarDec(t *testing.T) {
	...
	AssertEqual(t, "a", id.Text(), "should be a")
	AssertEqual(t, "1", init.Text(), "should be 1")
}
...
func TestVarDecArrPattern(t *testing.T) {
	...
	AssertEqual(t, "e", init.Text(), "should be e")

	arr := varDec.(*VarDec).id.(*ArrPat)
	elem0 := arr.elems[0].(*Ident)
	AssertEqual(t, "a", elem0.Text(), "should be a")

	elem1 := arr.elems[1].(*AssignPat)
	elem1Lhs := elem1.lhs.(*Ident)
	elem1Rhs := elem1.rhs.(*NumLit)
	AssertEqual(t, "b", elem1Lhs.Text(), "should be b")
	AssertEqual(t, "1", elem1Rhs.Text(), "should be 1")

	elem2 := arr.elems[2].(*AssignPat)
	elem2Lhs := elem2.lhs.(*ArrPat)
	elem2Rhs := elem2.rhs.(*NumLit)
	AssertEqual(t, "c", elem2Lhs.elems[0].(*Ident).Text(), "should be c")
	AssertEqual(t, "1", elem2Rhs.Text(), "should be 1")

	elem3 := arr.elems[3].(*ArrPat)
	elem31 := elem3.elems[0].(*AssignPat)
	AssertEqual(t, "d", elem31.lhs.(*Ident).Text(), "should be d")
	AssertEqual(t, "1", elem31.rhs.(*NumLit).Text(), "should be 1")
}
...
func TestVarDecArrPatternElision(t *testing.T) {
	...
	AssertEqual(t, "b", elem2.Text(), "should be b")
	...
	AssertEqual(t, "c", elem5.Text(), "should be c")
...
func TestObjLit(t *testing.T) {
	...
	AssertEqual(t, "a", prop0.arg.(*Ident).Text(), "should be ...a")

	prop1 := objLit.props[1].(*Prop)
	AssertEqual(t, "b", prop1.key.(*Ident).Text(), "should be b")

	prop2 := objLit.props[2].(*Spread)
	AssertEqual(t, "c", prop2.arg.(*Ident).Text(), "should be ...c")

	prop3 := objLit.props[3].(*Prop)
	AssertEqual(t, "d", prop3.key.(*StrLit).val, "should be d")
	AssertEqual(t, "1", prop3.value.(*NumLit).Text(), "should be 1")

	prop4 := objLit.props[4].(*Prop)
	AssertEqual(t, "e", prop4.key.(*Ident).Text(), "should be e")
	AssertEqual(t, "f", prop4.value.(*ObjLit).props[0].(*Prop).key.(*Ident).Text(), "should be f")
	AssertEqual(t, "1", prop4.value.(*ObjLit).props[0].(*Prop).value.(*NumLit).Text(), "should be 1")

	prop5 := objLit.props[5].(*Spread)
	AssertEqual(t, "g", prop5.arg.(*Ident).Text(), "should be ...g")
}
...
func TestObjLitMethod(t *testing.T) {
  ...
  `, nil)
	...
	id := varDec.(*VarDec).id.(*Ident)
	AssertEqual(t, "o", id.Text(), "should be o")

	objLit := varDec.(*VarDec).init.(*ObjLit)
	AssertEqual(t, 4, len(objLit.props), "should be len 6")

	prop0 := objLit.props[0].(*Prop)
	AssertEqual(t, "a", prop0.key.(*Ident).Text(), "should be a")
	...
	AssertEqual(t, "c", prop2.key.(*Ident).Text(), "should be c")

	prop3 := objLit.props[3].(*Prop)
	AssertEqual(t, "e", prop3.key.(*Ident).Text(), "should be e")
...
func TestIfStmt(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "a", stmt.test.(*Ident).Text(), "should be a")

	stmt = ast.(*Prog).stmts[1].(*IfStmt)
	AssertEqual(t, "c", stmt.test.(*Ident).Text(), "should be c")
}
...
func TestSwitchStmt(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "b", test0.lhs.(*Ident).Text(), "should be prog b")
	AssertEqual(t, "c", test0.rhs.(*Ident).Text(), "should be prog c")

	cons00 := case0.(*SwitchCase).cons[0].(*ExprStmt)
	AssertEqual(t, "d", cons00.expr.(*Ident).Text(), "should be prog d")

	cons01 := case0.(*SwitchCase).cons[1].(*ExprStmt)
	AssertEqual(t, "e", cons01.expr.(*Ident).Text(), "should be prog e")

	case1 := stmt.cases[1]
	AssertEqual(t, "f", case1.(*SwitchCase).test.(*Ident).Text(), "should be prog f")
...
func TestSwitchStmtDefaultMiddle(t *testing.T) {
  ...
  `, nil)
	...
	case2 := stmt.cases[2]
	AssertEqual(t, "f", case2.(*SwitchCase).test.(*Ident).Text(), "should be prog f")
}
...
func TestBrkStmt(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "a", stmt.label.(*Ident).Text(), "should be a")
}
...
func TestLabelStmt(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "a", lbStmt.label.(*Ident).Text(), "should be a")

	lbBody := lbStmt.body.(*ExprStmt)
	AssertEqual(t, "b", lbBody.expr.(*Ident).Text(), "should be b")

	expr := ast.(*Prog).stmts[1].(*ExprStmt)
	AssertEqual(t, "c", expr.expr.(*Ident).Text(), "should be c")
...
func TestRetStmt(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "a", stmt0.body.(*BlockStmt).body[0].(*RetStmt).arg.(*Ident).Text(), "should be a")
  ...
  `, nil)
	...
	AssertEqual(t, "a", stmt1.expr.(*Ident).Text(), "should be a")
}
...
func TestThrowStmt(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "a", stmt0.arg.(*Ident).Text(), "should be a")
...
func TestTryStmt(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "e", catch.(*Catch).param.(*Ident).Text(), "should be e")
...
func TestClassField(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "f1", elem0.key.(*Ident).Text(), "should be f1")
}
...
func TestClassMethod(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "f", elem2.key.(*Ident).Text(), "should be f")
}
...
func TestSeqExpr(t *testing.T) {
  ...
  `, nil)
	...
	AssertEqual(t, "b", seq.elems[0].(*Ident).Text(), "should be b")
	AssertEqual(t, "c", seq.elems[1].(*Ident).Text(), "should be c")
}
...
func TestTplExpr(t *testing.T) {
	...
	tag := tpl.tag.(*Ident)
	AssertEqual(t, "tag", tag.Text(), "should be tag")

	span0 := tpl.elems[0].(*StrLit)
	AssertEqual(t, "\na", span0.val, "should be a")

	span1 := tpl.elems[1].(*Ident)
	AssertEqual(t, "b", span1.Text(), "should be b")
...
func TestTplExprNest(t *testing.T) {
	...
	tag = tpl.tag.(*Ident)
	AssertEqual(t, "f", tag.Text(), "should be f")
	...
	span1 := tpl.elems[1].(*Ident)
	AssertEqual(t, "d", span1.Text(), "should be d")
}
...
func TestImportCall(t *testing.T) {
	...
	AssertEqual(t, "b", importCall.src.(*Ident).Text(), "should be b")
}
...
func TestMetaProp(t *testing.T) {
	...
	AssertEqual(t, "meta", metaProp.prop.(*Ident).Text(), "should be meta")
}
