...
func TestReadName(t *testing.T) {
	...
	l := NewLexer(s)
	tok, err := l.Next()
	assert.Equal(t, true, err == nil, "should be ok t")
	assert.Equal(t, "t", tok.text, "should be t")
	assert.Equal(t, 6, tok.loc.hi, "should be t")

	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok test")
...
func TestReadNum(t *testing.T) {
	...
	l := NewLexer(s)
	tok, err := l.Next()
	assert.Equal(t, true, err == nil, "should be ok 1")
	assert.Equal(t, "1", tok.Text(), "should be 1")

	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok 23")
	assert.Equal(t, "23", tok.Text(), "should be 23")

	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok 1e1")
	...
	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok .1_1")
	assert.Equal(t, ".1_1", tok.Text(), "should be .1_1")

	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok 1n")
	assert.Equal(t, "1n", tok.Text(), "should be 1n")

	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok 0b01")
	...
	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok 0o01")
	...
	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok 0x01")
	...
	tok, err = l.Next()
	assert.Equal(t, true, err == nil, "should be ok 0x0_1")
