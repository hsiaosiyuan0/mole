...
const (
	...
	// check for the flags of regexpr is not found in the spec
	FEAT_CHK_REGEXP_FLAGS   Feature = 1 << 10
	FEAT_REGEXP_UNICODE     Feature = 1 << 11 // from es6
	FEAT_REGEXP_STICKY      Feature = 1 << 12 // from es6
	FEAT_REGEXP_DOT_ALL     Feature = 1 << 13 // from es8
	FEAT_REGEXP_HAS_INDICES Feature = 1 << 14 // from es10
	...
	FEAT_CLASS_PRV        Feature = 1 << 19 // from es11
	FEAT_CLASS_PUB_FIELD  Feature = 1 << 20 // from es13
	FEAT_CLASS_PRIV_FIELD Feature = 1 << 21 // from es13
	FEAT_OPT_EXPR         Feature = 1 << 22 // from es11
	FEAT_OPT_CATCH_PARAM  Feature = 1 << 23 // from es10
	FEAT_NULLISH          Feature = 1 << 24 // from es11
)
